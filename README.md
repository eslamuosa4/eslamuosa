...
contract ReserveHold {
    ...
    function withdraw() external {
        ...
        total = 0;
        (bool success, ) = owner.call{value: amount}("");
        require(succ// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
